...
@TeleOp(name = "TetrixBot_Intake_TeleOp")
//@Disabled
public class TetrixBot_Intake_TeleOp extends LinearOpMode {

    // Motors
    final ElapsedTime runtime = new ElapsedTime();
    public DcMotor  leftDrive   = null; //the left drivetrain motor
    public DcMotor  rightDrive  = null; //the right drivetrain motor
    public DcMotor  intakeMotor    = null; //the arm motor
    ...
    public void runOpMode() {
        ...
        telemetry.addData("*  Trigger Left/Right ", "Intake Direction Forward/Reverse");
        ...
        while (opModeIsActive()) {
            ...
            if (gamepad1.right_trigger > 0.1) {
                intakeMotor.setPower(INTAKE_SPEED); // Arm speed forward
            } else if (gamepad1.left_trigger > 0.1) {
                intakeMotor.setPower(-INTAKE_SPEED); // Arm speed reverse
            } else {
            ...
            telemetry.addData("*  Right Joystick Left/Right ", "Turn Left/Right");
            telemetry.addData("*  Bumper Left/Right ", "Drive Speed Down/Up");
            telemetry.addData("*  Trigger Left/Right ", "Intake Forward/Reverse");
            telemetry.addData("Status", "Run Time: " + runtime);
            telemetry.addData("Drive Motors Power", "left (%.2f), right (%.2f)", leftPower, rightPower);
            telemetry.addData("Motor Speed", "drive (%.2f), turn (%.2f), arm (%.2f)", DRIVE_SPEED, TURN_SPEED, INTAKE_SPEED);
            telemetry.update();
        }
    }
}
